    ...
    <>
      ...
      >
        ...
        <Stack direction="column" spacing={0.5} sx={{ paddingBottom: "1rem" }}>
          ...
          >
            The Php version of my PHP / Laravel project is now 7.4. I&apos;d
            like to upgrade it to 7.4 from 8.2 (current stable PHP version). The
            script should work perfectly without any errors after upgrading the
            PHP version. It should be completed within two days and the script
            is my own and copyrighted, so it cannot be used for any other
            purpose. You can accept the invitation if you agree with this.
            Thanks a lot
          </Typography>
          <Stack
            direction="row"
